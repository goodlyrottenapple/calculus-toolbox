...
A deep embedding of a display calculus in Isabelle differs form the SE in these major points:

#### Proof trees as first-class citizens
...
#### Free variables as terms of the calculus
...
#### Custom defined mechanisms for derivation
