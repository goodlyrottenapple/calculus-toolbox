...
\begin{tikzpicture}[node distance =2cm and 6mm, auto]
    ...
    \node [block, right= of scala1] (comp1) {Comile Scala classes};

    \node [block, below of=scala1] (rule) {Parse calculus rules and print for Isabelle};
    ...
    \node [block, right= of scala2] (comp2) {Comile Scala classes};
